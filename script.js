...
"Entonces, los gritos se detienen y el palacio se sumerge en un extraño silencio. Con la amenaza destruida, lo único que queda por hacer es saquear el palacio y regresar a vuestro propio plano.",
        ...
        { 
            ...
            objetivos: "Ocupar todas las placas de presión simultáneamente",
            textoEscenario: ["Decidís enfrentaros a los oscuros pasajes bajo las alcantarillas de Gloomhaven, así que encendéis una antorcha y os adentráis en sus profundidades. Las paredes de ladrillo en ruinas finalmente dan paso a unos pasadizos hechos de piedra intrincada en un estado de deterioro extremo.",
"Grabado en las paredes se aprecia un irreconocible lenguaje rúnico. Por las grietas y las piedras que se han caído, resultaría difícil de leer incluso aunque lo conocierais.",
"Tras un rato avanzando por el pasadizo, finalmente llegáis a una sala más grande llena de una maquinaria en ruinas que ni siquiera comprendéis. Veis una puerta en la pared de enfrente, pero cuando os acercáis, un ruido metálico suena por toda la sala como si de una alarma se tratase. Entonces, la maquinaria comienza a moverse como si tuviera vida en un claro intento de atacar a cualquier intruso. Y esos intrusos sois vosotros.",
"Reglas especiales: Añade 3 cartas (-1) al mazo de modificadores de ataque de cada personaje como efecto del escenario",
"Os abrís camino por la sala de máquinas y os encontráis con unos pasillos que se dirigen a vuestra izquierda y a vuestra derecha. El sonido de la alarma proviene desde ambas direcciones. Puede que para detenerla tengáis que separaros.",
"Reglas especiales: Hay tantas placas de presión como personajes. Si el grupo lo componen 2 personajes, únicamente se colocan las placas a; si lo componen 3 se colocan las placas a y b; y si lo componen 4 se colocan las placas a, b y c."],
            conclusion: ["Desconocido"],
            recompensas: [],
            logros: ["desconocido"], 
            nuevasUbicaciones: ["Desconocido"] 
...
// ID 95: CUENTA PENDIENTE 
        { 
            ...
            textoEscenario: ["Camináis hasta el borde del hoyo y, de inmediato, la inquietud os invade. Aquí no hay ningún tesoro, no es más que un enorme agujero en la faz de la tierra. Intentáis dar un paso atrás, pero estáis paralizados. En ese momento, la esfera negra vibra en vuestras manos y, entonces, flota hacia el espacio sobre el abismo. Late de nuevo y una voz suena en vuestras cabezas.",
"—La codicia de los tontos es una gran motivación. Suponíais que podríais matar a mi señor, el gran Demonio Supremo, y luego caminar libres por vuestro mundo como si no fuera a pasaros nada. ¡Cuánta arrogancia! Vuestro castigo se acerca. ¡Entrad a mi prisión de tormento y languideced en vuestros pecados por el resto de la eternidad!",
"Vuestra mente consciente intenta alejarse del borde con desesperación, pero, en vez de eso, os veis dando un paso adelante y cayendo de cabeza a la oscuridad del hoyo. Cuando la oscuridad os envuelve, volvéis a sentir la sensación familiar de deambular entre planos.",
"El terrible dolor finalmente se calma y sentís el tacto de piedras ásperas contra la piel. Oís unas extrañas voces sobrenaturales. Abrís los ojos y descubrís que estáis en una especie de estadio. En la parte superior, demonios y otras criaturas miran hacia abajo y vitorean. Frente a vosotros hay una robusta puerta de barras de hierro y, detrás de ésta, un savvas de aspecto retorcido se ríe.",
"—¡Y así comienza vuestro juicio! —os grita—. Habéis matado a un demonio superior y depende de mí demostrar que no sois dignos de tal acción. Todo lo que debéis hacer es encontrar un camino a través de estas puertas y superarme en combate. Entonces, seréis devueltos a vuestro aburrido e insulso mundo. Pero, si, como sospecho, mi prisión os supera, recibiré el honor de torturaros durante el resto de vuestras cortas vidas.",
"--------(1)-------", 
"Las barras de hierro se abren de par en par y, ante vosotros, se encuentra el antagónico savvas envuelto en llamas. Los demonios de la parte de arriba aplauden el espectáculo, hambrientos de masacre.",
"—Me alegra que pudierais reuniros conmigo para el acto principal —dice el savvas con una sonrisa—. ¡Preparaos para ser juzgados!",
"El Río de lava savaas es el Lugarteniente Supremo"],
            conclusion: ["El savvas aúlla y cae de rodillas. —Tal vez sí que erais dignos —dice burlándose.",
"Con un rápido movimiento de espada, le separáis la cabeza de los hombros y su cuerpo sin vida cae al suelo. Los demonios rugen en una mezcla de indignación y emoción mientras os concentraís en vuestro aire."],
            recompensas: ["Cráneo de Vida (Objeto 119)"],
            logros: ["Ninguno"], 
            nuevasUbicaciones: ["Ninguna"] 
        },
    ],
